'''
142-Update system time from server
More Python snippets: stevepython.wordpress.com
...
server_list = ['time.windows.com', 'pool.ntp.org', 'ntp.iitb.ac.in', 'time.nist.gov']
